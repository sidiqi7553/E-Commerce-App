...
class _TrackingMapWidgetState extends State<TrackingMapWidget> {
  ...
  Widget build(BuildContext context) {
    print('Delivery man Lan : ${widget.deliveryManModel.latitude}');
    return Container(
      ...
      child: widget.deliveryManModel.latitude != null ? Stack(
        children: [
         ...
         ResponsiveHelper.isWeb() ? SizedBox() : _isLoading ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(Theme.of(context).primaryColor))) : SizedBox(),
        ],
